...
if (isset($_SESSION['idUser']) && !empty($_SESSION['idUser'])) {
    ...
    $nm_jogo = $_GET["nm_jogo"];
    $ds_jogo = $_GET["ds_jogo"];
    $ds_genero = $_GET["ds_genero"];
    $img_principal = $_GET["img_principal"];
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="jogos">
                ...
                <div class="card-jogo">
                    <img src=<?php echo "'../assets/jogos/{$img_principal}'"; ?> alt=<?php echo "'{$img_principal}'"; ?>>
                    <div class="card-informacoes">
                        <h3 class="card-titulo"><?php echo $nm_jogo; ?></h3>
                        <p class="card-texto"><?php echo $ds_jogo; ?></p>
                        <p class="card-genero">Gênero: <?php echo $ds_genero; ?></p>
                    </div>
                </div>
